...
func main() {
	...
	case 4:
		result = aoc.Day04(puzzlePath+"04.txt", int(part))
	case 5:
		result = aoc.Day05(puzzlePath+"05-p1.txt", int(part), false)
	case 6:
		result = aoc.Day06(puzzlePath+"06.txt", int(part))
	case 7:
		result = aoc.Day07(puzzlePath+"07.txt", int(part))
	}
